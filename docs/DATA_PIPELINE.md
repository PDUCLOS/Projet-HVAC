...
|---------|---------|-------|-----------------|
| `cop_proxy` | 4.5 - 0.08×frost - 0.0005×alt | [1.0, 5.0] | Estimated heat pump efficiency |
| `is_mountain` | altitude > 800m | 0/1 | High-altitude structural flag |
